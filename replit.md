...
- `POST /api/subscriptions/create` - GP creates subscription doc with amount, pushes for LP signing (creates Subscription record)
...
- **Fund Threshold E2E (11 tests)**: Configurable capital call threshold, enforcement, settings API, audit logging
- **E2E Flows (61 tests)**:

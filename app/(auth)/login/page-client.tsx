        ...
        <div className="z-10 mx-5 h-fit w-full max-w-md overflow-hidden rounded-lg sm:mx-0">
          ...
          >
            <Button
              ...
              className="mb-4 flex w-full items-center justify-center gap-2 rounded border border-gray-600 bg-transparent px-4 py-2 text-white transition-colors duration-300 hover:bg-gray-800"
            >

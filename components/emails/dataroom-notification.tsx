...
export default function DataroomNotification({
  ...
  url = "https://dataroom.bermudafranchisegroup.com/datarooms/123",
  unsubscribeUrl = "https://dataroom.bermudafranchisegroup.com/datarooms/123/unsubscribe",
}: {
  dataroomName: string;
      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm text-gray-400">BF Fund Dataroom</Text>

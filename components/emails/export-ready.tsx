...
export default function ExportReady({
  resourceName = "Export",
  downloadUrl = "https://dataroom.bermudafranchisegroup.com/datarooms/123",
        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm leading-6 text-black">
              The export you requested is ready to download from your BF Fund
              Dataroom account. Make sure you&apos;re signed into this account, and click
